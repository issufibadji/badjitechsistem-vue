<template>
  <section id="planos" class="py-20 bg-white text-center">
    <div class="mb-10">
      <h5 class="text-sm text-blue-600 font-bold uppercase">PLANOS</h5>
      <h1 class="text-3xl font-bold text-gray-800 mt-2">Escolha o plano ideal para você</h1>
    </div>
